...
public class TypeFaceEditTextView extends EditText {
    ...
    public TypeFaceEditTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs,
                    R.styleable.TypeFaceEditTextView);
            String ttfType = a.getString(R.styleable.TypeFaceEditTextView_text_font);
            ...
            if (tf != null)
                setTypeface(tf);
            adjustTopForAscent = a.getBoolean(R.styleable.TypeFaceEditTextView_adjust_top_ascent, false);
            autoMarquee = a.getBoolean(R.styleable.TypeFaceEditTextView_auto_marquee, false);
