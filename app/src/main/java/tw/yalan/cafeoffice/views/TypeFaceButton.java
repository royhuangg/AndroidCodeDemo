...
public class TypeFaceButton extends android.support.v7.widget.AppCompatButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            String ttfType = a.getString(R.styleable.TypeFaceButton_text_font);
            ...
            if (tf != null)
                setTypeface(tf);
            adjustTopForAscent = a.getBoolean(R.styleable.TypeFaceButton_adjust_top_ascent, false);
            autoMarquee = a.getBoolean(R.styleable.TypeFaceButton_auto_marquee, false);
