 ...
 * <p>
 * Created by Alan Ding on 2016/11/17.
 * <p>
 * Created by Alan Ding on 2016/11/17.
 * <p>
 * Created by Alan Ding on 2016/11/17.
...
public class ExpandableLayout extends LinearLayout {
    ...
    private void playExpandAnimation(final View child) {
        ...
        mExpandAnimator.addUpdateListener(new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                dispatchOffset(child, measuredHeight);
                child.requestLayout();
            }
        });
    ...
    void dispatchOffset(View child, int measuredHeight) {
        if (mListener != null) {
            mListener.onExpandOffset(this, child, child.getHeight(), measuredHeight,
                    !isExpanded());
        }
    }
    ...
    public static interface OnExpandListener {
        ...
        public void onExpandOffset(ExpandableLayout view, View child,
                                   float offset, int measuredHeight, boolean isExpanding);
    }
}
