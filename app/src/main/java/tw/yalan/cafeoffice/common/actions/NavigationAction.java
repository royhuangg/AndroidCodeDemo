...
//            Intent i = new Intent(
//                    Intent.ACTION_VIEW,
//                    Uri.parse("google.navigation:q=" + endLat + "," + endLng + "&hl=zh&t=m&mode=" + way));
//            i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK
//                    & Intent.FLAG_ACTIVITY_EXCLUDE_FROM_RECENTS);
...
//            context.startActivity(i);
            Intent i = new Intent(
                    Intent.ACTION_VIEW,
                    Uri.parse("http://maps.google.com.tw/maps?f=d&source=s_d&daddr=" + endLat + "," + endLng + "&hl=zh&t=m&dirflg=" + way));
            i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK
                    & Intent.FLAG_ACTIVITY_EXCLUDE_FROM_RECENTS);
            i.setClassName("com.google.android.apps.maps",
                    "com.google.android.maps.MapsActivity");
